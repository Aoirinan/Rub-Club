...
export default function SiteStaffAdminPage() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-8">
      <h1 className="text-2xl font-bold text-slate-900">Staff pages</h1>
      <p className="mt-1 text-sm text-slate-600">
        Add photos and bios for Paris and Sulphur Springs staff pages. Changes go live after you save.
      </p>
      {banner ? (
