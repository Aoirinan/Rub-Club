...
const PAGE_NAV: { key: SiteContentNavKey; label: string }[] = [
  ...
  { key: "SS massage page", label: "SS massage" },
  { key: "SS contact page", label: "SS contact" },
  { key: "SS doctors", label: "SS doctors" },
  { key: "SS / office", label: "SS office" },
  { key: "Sulphur staff", label: "Sulphur staff" },
  { key: "SS subpages", label: "SS services" },
  { key: "SS conditions", label: "SS conditions" },
  { key: "SS patient resources", label: "SS resources" },
  { key: "SS wellness", label: "SS wellness" },
  { key: "SS prices", label: "SS prices" },
  { key: "SS insurance", label: "SS insurance" },
  { key: "SS reviews", label: "SS reviews" },
  { key: "SS patient forms", label: "SS patient forms" },
  ...
  { key: "Paris header & footer", label: "Paris header" },
  { key: "SS header & footer", label: "SS header" },
  { key: "Paris photos", label: "Paris photos" },
  { key: "SS photos", label: "SS photos" },
...
const BADGE_CLASS: Record<string, string> = {
  ...
  "Paris header & footer": "bg-slate-300 text-slate-900",
  "SS header & footer": "bg-slate-300 text-slate-900",
  "Paris photos": "bg-fuchsia-100 text-fuchsia-900",
  "SS photos": "bg-fuchsia-100 text-fuchsia-900",
  "Site settings": "bg-slate-400 text-white",
