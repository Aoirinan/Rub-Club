...
export function MassageRubClubSection({ stressTitleAs = "h2" }: Props) {
  ...
  return (
    <section
      id="the-rub-club"
      className="scroll-mt-32 border-t-4 border-[#c0392b] bg-white p-6 shadow-md sm:p-10"
    >
      <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
        <div className="space-y-5">
          <TitleTag className="text-3xl font-black text-[#4a1515]">{MASSAGE.stressTitle}</TitleTag>
      ...
      <div className="mt-10 grid gap-10 border-t border-stone-200 pt-8 lg:grid-cols-2">
        <div>
          <h2 className="text-xl font-black text-[#4a1515]">{MASSAGE.whenTitle}</h2>
          <p className="mt-4 leading-relaxed text-stone-700">{MASSAGE.whenBody}</p>
        </div>
        <div>
          <h2 className="text-xl font-black text-[#4a1515]">{MASSAGE.treatmentsTitle}</h2>
      ...
      <div className="mt-10 bg-[#f2efe3] p-6">
        <h2 className="text-2xl font-black text-[#4a1515]">{MASSAGE.closingTitle}</h2>
