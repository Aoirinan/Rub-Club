    ...
    <div className="divide-y divide-stone-200">
      {entries.map((e) => (
        <details key={e.q} className="group py-4">
          <summary className="focus-ring flex cursor-pointer items-center justify-between gap-3 text-base font-bold text-[#4a1515]">
            <span>{e.q}</span>
            <span
              aria-hidden
              className="text-xl font-black text-[#c0392b] transition group-open:rotate-45"
            >
              +
            </span>
          </summary>
