          ...
          <div className="mobile-drawer-panel absolute right-0 top-0 h-full w-[88%] max-w-sm overflow-y-auto bg-white shadow-2xl">
            <div className="flex items-center justify-between border-b border-stone-200 px-4 py-3">
              ...
              <button
                ...
                onClick={close}
                aria-label="Close menu"
                className="focus-ring rounded p-2 text-[#4a1515]"
              >
            ...
            <nav aria-label="Mobile" className="flex flex-col">
                      ...
                      <div className="bg-stone-50 pb-2">
                        {item.clinics?.length
                          ? item.clinics.map((clinic) => (
                              ...
                              >
                                <p className="text-xs font-black uppercase tracking-wide text-[#4a1515]">
                                  {clinic.name}
                                </p>
                                ...
                                <div className="mt-1 space-y-0.5">
                                  {clinic.phones.map((p) => (
                                    <a
                                      ...
                                      className="block text-xs font-bold text-[#c0392b] underline"
                                      onClick={() =>
                          ...
                          : item.children!.map((c) => (
                              <Link
                                key={c.href}
                                href={c.href}
                                className="focus-ring block px-8 py-2 text-xs font-bold uppercase tracking-wide text-[#4a1515]/80 hover:text-[#c0392b]"
                                onClick={close}
                              >
                                {c.label}
                              </Link>
              ...
              {!hasGiftCardInNav ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`focus-ring mx-4 mb-2 block border border-[#c0392b]/30 bg-white px-4 py-3 text-center text-sm font-black uppercase tracking-wide text-[#c0392b] transition-all duration-300 ease-out hover:bg-stone-50 motion-reduce:transition-none ${
              ...
              <div className="border-t border-stone-200 p-4 text-sm">
                ...
                {businessContext === "paris_chiro" ? (
                  <a
                    className="block py-1 font-bold text-[#c0392b] underline"
