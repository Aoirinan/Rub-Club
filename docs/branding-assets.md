...
| **Logos in header** (`BrandLogoStrip`) | Rub Club: legacy practice website CDN; Chiro: `public/logos/` (replace with file from Sean); SS: `public/images/staff-ss/` | Logos are the **clinic’s** lockups from their own sites, not EZnet or other scheduler vendors. |
